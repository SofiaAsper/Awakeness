...
{
    public enum GunType { raycast, rigidbody,Melee }; 
    public enum ShootType { semi, auto, burst };

    public string prefabName;
    public GameObject prefabObj;
    public GameObject gunPickupObj;
    ...
    public float fireDelayOnFreeShoot = 0f; //0 to shoot instantly- daley added to the joystick free shoot (shoot button)
    [Range(0f, 2f)]
    ...
    [Range(0f, 0.8f)]
    public float aimDownMultiplier = 0.2f;
