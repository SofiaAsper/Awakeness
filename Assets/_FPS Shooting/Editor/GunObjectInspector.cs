...
public class GunObjectInspector : Editor
{
    ...
    private SerializedProperty gunPickupObj;
    ...
    private SerializedProperty fireDelayOnFreeShoot;
    ...
    private SerializedProperty AimStop;
    ...
    private void OnEnable()
    {
        ...
        gunPickupObj = this.serializedObject.FindProperty("gunPickupObj");
        ...
        fireDelayOnFreeShoot = this.serializedObject.FindProperty("fireDelayOnFreeShoot");
        ...
        AimStop = this.serializedObject.FindProperty("AimStop");
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.PropertyField(gunPickupObj);
        ...
        if (showGunVariables)
        {
            ...
            EditorGUILayout.PropertyField(AimStop);
            ...
            EditorGUILayout.PropertyField(fireDelayOnFreeShoot);
            if (gun.fireDelay > 0)
            {
