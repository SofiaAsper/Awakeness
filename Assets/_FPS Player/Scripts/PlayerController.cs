...
public class PlayerController : MonoBehaviour
{
    ...
    void UpdateMovingStatus()
    {
        ...
        staminaBar.SetStamina(stamina, sprintTime);
    ...
    // if player is running play concreteRun audio
    void PlayAudio(bool jumped)
    {
        if (jumped)
        {
        ...
        {
            audioManager.Play("GrassRun");
        }
        else if (movement.controller.velocity.magnitude > 0f)
        {
            audioManager.Play("GrassWalk");
